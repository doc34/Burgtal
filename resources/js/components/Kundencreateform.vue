    ...
    <div class="card-header bg-transparent">
        ...
        <div class="form-row">
            <div class="custom-control custom-checkbox m-3">
                <input type="checkbox" class="custom-control-input" :class="classkundenconf" id="customControlValidation1" required v-model="kundenconf" />
            ...
            <div class="custom-control custom-checkbox m-3">
                <input type="checkbox" class="custom-control-input" :class="classlieferantconf" id="customControlValidation2" required v-model="lieferantconf" />
            ...
            <form @submit.prevent="addPost">
                <div class="row">
                    <div class="form-group col-md-4 col-sm-12">
                        ...
                        <select class="custom-select mr-sm-2" :class="classanrede" id="exampleFormControlSelect1" v-model="confanrede">
                            <option v-for=" anrede in anrede.data.anrede " :key="anrede.id" :value="anrede.id">{{anrede.anrede}}</option>
                        </select>
                    </div>

                    <div class="form-group col-md-4 col-sm-12">
                        <label for="exampleFormControlSelect1">Partner-Typ</label>
                        <select class="custom-select mr-sm-2" :class="classpartnertypeid" id="exampleFormControlSelect1" v-model="confpartnertypeid">
                            <option v-for=" partnertype in partnertyp.data.partnertype " :key="partnertype.id" :value="partnertype.id">{{partnertype.partnertyp}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4 col-sm-12">
                        ...
                        <input type="text" class="form-control" id="inputFirma" placeholder="Alias" v-model="query.alias" />
                    </div>

                    <div class="form-group col-md-4">
                        <label for="inputName">Name</label>
                        <input type="text" class="form-control" :class="classname " id="inputName" placeholder="Name" v-model="confname" />
                    </div>

                    <div class="form-group col-md-4">
                        <label for="inputVorname">Vorname</label>
                        <input type="text" class="form-control" :class="classvorname" id="inputVorname" placeholder="Vorname" v-model="confvorname" />
                    </div>
                </div>

                <div class="form-group">
                    <label for="inputAddress">Strasse</label>
                    <input type="text" class="form-control" :class="classstrasse" id="inputAddress" placeholder="1234 Main St" v-model="confstrasse" />
                </div>

                <div class="form-row">
                    <div class="form-group col-md-4 col-sm-12">
                        <label for="inputplz">PLZ</label>
                        <input type="text" class="form-control" :class="classplz" id="inputplz" v-model="confplz" />
                    </div>
                    <div class="form-group col-md-4 col-sm-12">
                        <label for="inputORT">Ort</label>
                        <input type="text" class="form-control" :class="classort" id="inputORT" v-model="confort" />
                    </div>
                    <div class="form-group col-md-4 col-sm-12">
                    ...
                    <div class="form-group col-md-4 col-sm-12">
                        ...
                        <input type="text" class="form-control" id="inputTelefon" placeholder="0258745800" v-model="query.tel" />
                    </div>

                    <div class="form-group col-md-4 col-sm-12">
                        <label for="inputHandy">Handy</label>
                        <input type="text" class="form-control" id="inputHandy" placeholder="0258745800" v-model="query.handy" />
                    </div>
                    <div class="form-group col-md-4 col-sm-12">
                        <label for="inputMail">E-Mail</label>
                        <input type="e-mail" class="form-control" id="inputMail" placeholder="Mail" v-model="query.email" />
                    </div>
                </div>
                <!-- Firma Form -->
                <div v-if="showfirma === true">
                    <div class="row">
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <input type="text" class="form-control" id="inputHandy" placeholder="0258745800" v-model="query.steuernummer" />
                        </div>
                        <div class="form-group col-md-4 col-sm-12">
                            <label for="inputHandy">Amtsgericht</label>
                            <input type="text" class="form-control" id="inputHandy" placeholder="0258745800" v-model="query.amsgericht" />
                        </div>
                        <div class="form-group col-md-4 col-sm-12">
                            <label for="inputHandy">Handelsregister-Nummer</label>
                            <input type="text" class="form-control" id="inputHandy" placeholder="0258745800" v-model="query.handelnummer" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="custom-control custom-switch form-group col-md-4 col-sm-12 mt-3">
                            <input type="checkbox" class="custom-control-input" id="customSwitch1" />
                            <label class="custom-control-label" for="customSwitch1">Umsatzsteuerpflichtig Ja/Nein</label>
                        </div>
                        <div class="form-group col-md-4 col-sm-12">
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <select class="custom-select mr-sm-2" id="exampleFormControlSelect1" v-model="query.rechtsform_id">
                                <option v-for="rechtsform in rechtsform.data.rechtsform " :key="rechtsform.id" :value="rechtsform.id">{{ rechtsform.recht_cod + '- '+ rechtsform.rechtform}}</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <button v-if="classanrede == 'is-valid' && classpartnertypeid=='is-valid' && classname == 'is-valid' && classvorname == 'is-valid'
                && classstrasse == 'is-valid' && classplz == 'is-valid' && classort == 'is-valid' " type="submit" class="btn btn-primary">Sign in</button>
